...
namespace Content
{
    public class IamContent : IContent
    {
        ...
        {
            //在卡牌放反的情况下，倒序排列
            if((trackers[3].OnGetCurrentTransform().name.ToLower().Equals("i") && trackers[2].OnGetCurrentTransform().name.ToLower().Equals("am")) || (trackers[2].OnGetCurrentTransform().name.ToLower().Equals("i") && trackers[3].OnGetCurrentTransform().name.ToLower().Equals("am")))
        ...
        {
            if (trackers[0].OnGetCurrentTransform().name.ToLower().Equals("i"))
            {
                //当期句子时陈述句
            ...
            else if (trackers[0].OnGetCurrentTransform().name.ToLower().Equals("am"))
            {
                //当前句子时问句
